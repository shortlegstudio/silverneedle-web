...
cp -r silverneedle-web/data $PROJECT_PATH/Assets/data
...
$UNITY -quit -batchmode -projectPath=$PROJECT_PATH -exportPackage Assets/data Assets/silverneedle Assets/Handlebars Assets/YamlDotNet silverneedle-package.unitypackage