...
namespace SilverNeedle.Actions.CharacterGeneration.SpellCasting
{
    ...
    public class BuildSpellList : ICharacterDesignStep
    {
        ...
        public void ExecuteStep(CharacterSheet character)
        {
            ...
            if(!character.Contains<DivineCasting>())
                return;

            foreach(var spellcasting in character.GetAll<DivineCasting>())
            {
                SpellList spellList;
        ...
        private void AddAllSpells(DivineCasting casting, CharacterStrategy strategy, SpellList spellList)
        {
